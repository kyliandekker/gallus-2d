...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	tool::core::TOOL = new tool::core::EditorTool();
	tool::core::TOOL->SetSaveDirectory(saveDirPath);
	tool::core::TOOL->SetDX12System<tool::graphics::dx12::DX12BaseSystem>();
	tool::core::TOOL->GetDX12().GetImGuiWindow().AddWindow(new tool::graphics::imgui::MainWindowDock(tool::core::TOOL->GetDX12().GetImGuiWindow()));
	tool::core::TOOL->GetDX12().GetImGuiWindow().AddWindow(new tool::graphics::imgui::editor::ConsoleWindow(tool::core::TOOL->GetDX12().GetImGuiWindow()));
